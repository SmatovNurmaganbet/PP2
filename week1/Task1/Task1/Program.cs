...
namespace Task1
{
    class Program
    {
                ...
                {
                int n = int.Parse(Console.ReadLine()); //I set the size of the array and declare the array 
                int[] a = new int[n];
                int x = n;
                string[] arr = Console.ReadLine().Split(); //I write the values ​​of the type string into the array
